...
**CRITICAL: Read `scripts/prompts/005-stripe-reference.md` in this repo FIRST. It contains verified current Stripe SDK patterns (v20.x, API version 2025-12-15.clover). Use these patterns exactly. Do NOT use patterns from your training data — the Stripe API has changed.**
