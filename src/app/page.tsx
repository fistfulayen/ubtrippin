  ...
  return (
    <div className="min-h-screen" style={{ background: '#f5f3ef' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4"
           style={{ background: 'rgba(245,243,239,0.9)', backdropFilter: 'blur(8px)', borderBottom: '1px solid #c7c2b8' }}>
        <Image
        ...
        <Link
          href="/login"
          className="px-5 py-2 text-sm tracking-wide uppercase bg-[#1e1b4b] text-[#f5f3ef] hover:bg-[#312e81] transition-colors font-medium"
        >
          Sign in
        </Link>
      </nav>
      ...
      <main>
        ...
        <section className="pt-36 pb-24 px-6 text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-serif text-[#1e1b4b] leading-tight mb-8 tracking-tight hero-title">
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-3 px-10 py-5 text-base tracking-widest uppercase bg-[#1e1b4b] text-[#f5f3ef] hover:bg-[#312e81] transition-all font-medium shadow-2xl hover:scale-105 border-2 border-[#1e1b4b] cta-button"
          >
            <Image
        ...
        {/* ─── Divider ─── */}
        <div className="border-t-2 border-[#c7c2b8] max-w-4xl mx-auto" />

        {/* ─── Setup Guide ─── */}
        <section className="py-28 px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-center text-3xl font-serif text-[#1e1b4b] mb-4 tracking-tight">
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  num: '2',
                  icon: '/evelope_icon.png',
                  title: <>Forward your itinerary to <span className="font-mono text-sm bg-[#c7c2b8] px-1.5 py-0.5 rounded text-[#1e1b4b]">trips@ubtrippin.xyz</span></>,
                ...
                <div key={step.num} className="flex items-start gap-5">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#1e1b4b] text-[#f5f3ef] font-mono text-sm flex items-center justify-center font-bold">
                    {step.num}
                  </div>
                  <div>
                    <h3 className="text-xl font-serif text-[#1e1b4b] mb-1">{step.title}</h3>
        ...
        <section className="py-28 px-6">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-center text-3xl font-serif text-[#1e1b4b] mb-20 tracking-tight">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div
                  key={feat.title}
                  className="p-6 border-2 border-[#c7c2b8] hover:border-[#b45309] transition-colors"
                  style={{ background: '#eceae4' }}
                >
                  <div className="text-2xl mb-3">{feat.icon}</div>
                  <h3 className="text-base font-semibold text-[#1e1b4b] mb-2 uppercase tracking-wide">{feat.title}</h3>
        ...
        <section className="py-28 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="inline-block text-xs font-mono uppercase tracking-widest text-[#4338ca] border border-[#b45309] px-3 py-1 mb-6">
              For AI agents
            </div>
            <h2 className="text-3xl font-serif text-[#1e1b4b] mb-5 tracking-tight leading-snug">
            ...
            <div className="space-y-4 mb-8">
              <h3 className="text-lg font-serif text-[#1e1b4b]">Agent setup</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={step.num} className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#1e1b4b] text-[#f5f3ef] text-xs font-mono flex items-center justify-center">{step.num}</span>
            ...
            <div className="font-mono text-sm p-5 text-[#f5f3ef] space-y-1" style={{ background: '#1e1b4b' }}>
        ...
        <section className="py-16 px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {[
              ...
              <span
                key={type}
                className="px-5 py-2 text-xs tracking-widest uppercase bg-[#eceae4] text-[#1e1b4b] border border-[#c7c2b8] font-medium"
              >
                {type}
              </span>
            ))}
        ...
        <section className="py-28 px-6 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            />
            <h2 className="text-4xl font-serif text-[#1e1b4b] mb-6 tracking-tight">
            ...
            <p className="text-[#4338ca] leading-relaxed mb-10">
              In the meantime,{' '}
              <a href="mailto:hello@ubtrippin.xyz" className="underline hover:text-[#1e1b4b]">
                mail us
              </a>
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-3 px-10 py-5 text-base tracking-widest uppercase bg-[#1e1b4b] text-[#f5f3ef] hover:bg-[#312e81] transition-all font-medium shadow-2xl hover:scale-105 border-2 border-[#1e1b4b]"
            >
              <Image
                src="/airplane_icon.png"
                alt=""
      ...
      {/* ─── Footer ─── */}
      <footer className="border-t-2 border-[#c7c2b8] py-10 mt-4">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs tracking-widest uppercase text-[#4338ca]">
          <div className="flex items-center gap-5">
            <a href="/privacy" className="hover:text-[#1e1b4b] transition-colors">Privacy</a>
            <span className="text-[#c7c2b8]">·</span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-[#1e1b4b] transition-colors flex items-center gap-1.5"
            >
          ...
          <p className="text-[#b45309]">&copy; {new Date().getFullYear()} UBTRIPPIN</p>
        </div>
      </footer>
    </div>
  )
