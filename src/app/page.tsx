    ...
    <div className="min-h-screen" style={{ background: '#ede6cf' }}>
      ...
      <main>
        ...
        <section className="pt-36 pb-24 px-6 text-center max-w-5xl mx-auto">
          ...
          <p className="max-w-2xl mx-auto text-xl sm:text-2xl text-[#544836] leading-relaxed font-light mb-12">
        ...
        <section className="py-28 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-[#544836] mb-16 text-lg">No app to install. No inbox access needed.</p>
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  num: '2',
                  icon: '/evelope_icon.png',
                  title: <>Forward your itinerary to <span className="font-mono text-sm bg-[#d4c9b0] px-1.5 py-0.5 rounded text-[#2a2419]">trips@ubtrippin.xyz</span></>,
                ...
                <div key={step.num} className="flex items-start gap-5">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#2a2419] text-[#ede6cf] font-mono text-sm flex items-center justify-center font-bold">
                    {step.num}
                  </div>
                  <div>
                    <h3 className="text-xl font-serif text-[#2a2419] mb-1">{step.title}</h3>
                    <p className="text-[#544836] leading-relaxed">{step.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="py-28 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-[#544836] leading-relaxed mb-8 max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
              <h3 className="text-lg font-serif text-[#2a2419]">Agent setup</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={step.num} className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#2a2419] text-[#ede6cf] text-xs font-mono flex items-center justify-center">{step.num}</span>
                    <p className="text-[#544836]">{step.text}</p>
                  </div>
                ))}
              </div>
            </div>

            <div className="font-mono text-sm p-5 text-[#ede6cf] space-y-1" style={{ background: '#2a2419' }}>
            ...
            <p className="mt-6 text-sm text-[#544836]">
              Full API docs at{' '}
              <a
                href="https://github.com/fistfulayen/ubtrippin/blob/main/docs/API.md"
                target="_blank"
                rel="noopener noreferrer"
                className="underline hover:text-[#2a2419]"
              >
                docs/API.md
              </a>
        ...
        <section className="py-28 px-6 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-[#544836] text-lg leading-relaxed mb-6">
            ...
            <p className="text-[#544836] leading-relaxed mb-10">
              In the meantime,{' '}
              <a href="mailto:hello@ubtrippin.xyz" className="underline hover:text-[#2a2419]">
                mail us
              </a>
      ...
      <footer className="border-t-2 border-[#d4c9b0] py-10 mt-4">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs tracking-widest uppercase text-[#544836]">
          ...
          <p className="text-[#a89878]">&copy; {new Date().getFullYear()} UBTRIPPIN</p>
        </div>
      </footer>
    </div>
  )
