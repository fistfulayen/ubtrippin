  ...
  return (
    <div className="relative overflow-hidden rounded-2xl">
      ...
      {trip.cover_image_url ? (
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#f1f5f9] to-[#ffffff]" />
      )}
        ...
        >
          {(trip.start_date || trip.end_date) && (
            <div className="flex items-center gap-1.5">
              <Calendar
                className={`h-4 w-4 ${trip.cover_image_url ? 'text-white' : 'text-[#4f46e5]'}`}
              />
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="flex items-center justify-between rounded-xl border border-gray-200 p-4">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4f46e5] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 ${
                  shareEnabled ? 'bg-[#1e293b]' : 'bg-gray-200'
                }`}
              >
                <span
