...
export function CarDetailsView({ details }: CarDetailsViewProps) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gradient-to-br from-[#ffffff] to-gray-100 p-4">
      {/* Header row */}
      <div className="flex items-center justify-between">
        ...
        {vehicle_type && (
          <span className="flex items-center gap-1 rounded bg-[#f1f5f9] px-2 py-0.5 text-sm font-medium text-[#4f46e5]">
